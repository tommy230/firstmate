...
# Exact untracked turn-end hook files generated by fm-spawn are ignored for the
# dirty check and removed before returning the worktree; tracked edits to those
# same paths still count as real work and refuse teardown.
